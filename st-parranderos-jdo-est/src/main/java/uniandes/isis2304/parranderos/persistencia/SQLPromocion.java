...
/**
 * Clase que encapsula los métodos que hacen acceso a la base de datos para el concepto PROMOCION de Parranderos
...
class SQLPromocion {
	...
	{
        Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaPromocion() + "(id, idproducto, precio, descripcion, fechainicio, fechafin, unidadesdisponibles) values (?, ?, ?, ?, ?, ?, ?)");
	...
	/**
	 * Crea y ejecuta la sentencia SQL para eliminar TODAS LAS PROMOCIONES de la base de datos de Parranderos
	 * @param pm - El manejador de persistencia
	 * @return EL número de tuplas eliminadas
	 */
